...
public class KThread {
    ...
    public static void finish() {
        ...
        if (currentThread.joinThread != null)
        {
         ...
         currentThread.linkedThread.nextThread();
    ...
    public static void selfTest() {
        ...
        System.out.println("This is the test for task 1 : join()");
        System.out.println(" ");

        /* Make sure a thread will wait for the thread that it called join for. */
        KThread kt = new KThread(new PingTest(1));
        kt.setName("forked thread");
        kt.fork();
        kt.join();
        new PingTest(0).run();
